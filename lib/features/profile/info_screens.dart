...
class HelpGuideScreen extends StatelessWidget {
  ...
  static HelpGuideScreen drivers(BuildContext context) => HelpGuideScreen(
    ...
    items: const [
      ...
      HelpGuideItem(
        title: 'Будьте на связи и в безопасности',
        description:
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Хорошей дороги! Если остались вопросы — напишите нам в поддержку.',
              style: HSText.subheadline
...
class LegalDocumentScreen extends StatelessWidget {
  ...
  static LegalDocumentScreen terms() => const LegalDocumentScreen(
    ...
    sections: [
      ...
      LegalSection(
        title: 'Правила публикаций и поведения',
        body:
      ...
      LegalSection(
        title: 'Жалобы, блокировка и модерация',
        body:
      ...
      LegalSection(
        title: 'Аккаунт, изменения и контакты',
        body:
